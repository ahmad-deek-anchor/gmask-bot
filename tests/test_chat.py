...
def test_default_tools_include_desk_tools():
    ...
    from tools.macro_tools import MACRO_TOOL_NAMES
    assert names[n_after_intra:n_after_intra + len(MACRO_TOOL_NAMES)] == MACRO_TOOL_NAMES
    n_after_intra += len(MACRO_TOOL_NAMES)
